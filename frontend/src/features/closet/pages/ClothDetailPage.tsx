...
import ClothDetailItem from '../components/ClothDetailItem';
	...
	return (
		<div className='flex flex-col h-screen bg-white max-w-md mx-auto'>
			...
			<div className='flex-1 overflow-auto pb-20'>
				<CodiEditor item={clothItem}>
					<div className='px-4'>
						<ClothDetailItem label='상품명' value={clothItem.name} />
						<ClothDetailItem label='카테고리' value={clothItem.category} />
